...
(function() {
  "use strict";
  var Context, EventEmitter, Fact, FlowContainer, InitialFact, Promise, WorkingMemory, bind, compile, declare, extd, flows, forEach, fs, isNoolsFile, nools, parse, path, rule, wm;
  ...
  FlowContainer = declare({
    instance: {
      ...
      match: function(cb) {
        var c, constraints, context, csFacts, dRule, fact, i, j, ret, satisfyingFacts, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _m, _n, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;
          ...
          if (this.checkFire(dRule)) {
            ...
            for (i = _n = 0, _len5 = _ref5.length; _n < _len5; i = ++_n) {
              ...
              if (i !== 0) {
                ...
                c.set(dRule.constraintsList[i][0].alias, satisfyingFacts[0].object);
